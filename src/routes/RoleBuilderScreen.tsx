...
import { createRole, type ModulePermissionInput, type PermissionModuleValue } from '@/features/roles/api'
...
/**
 * SC-038 · Create Role Builder (module × Add/Edit/Delete/Listing) — SA (FR-017).
 *
 * Reuses the approved Sc038RoleBuilder.tsx structure/components as-is
 * (Step 16) for the CREATE flow — editing an existing role is FR-018's
 * scope, not this ticket's (ticket's own out-of-scope note covers
 * assigning roles to staff; FR-018's own title, "Assign/edit/delete
 * roles," is where edit lives). The design's own module/operation list
 * (`staffroles.ts`) is a 5-module placeholder that doesn't match the
 * ticket/dbml/Gherkin's real 4x4 set — the real set is used here (see
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-2xl">
        ...
        <h1 className="text-2xl font-bold text-ink">Create role</h1>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <Card className="mt-4">
            <div className="border-b border-line px-5 py-3 text-sm font-semibold text-ink">Permissions</div>
